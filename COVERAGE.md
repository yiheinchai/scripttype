...
|---|--:|--:|--:|--:|--:|--:|--:|
| 03-schema-and-type-level-parsers/typebox | 910 | 861 | 94.6% | 94.6% | 2 | 0 | 0 |
| 03-schema-and-type-level-parsers/arktype | 759 | 640 | 84.3% | 84.3% | 14 | 7 | 0 |
| 05-functional-effects-hkt/effect | 693 | 494 | 71.3% | 71.3% | 9 | 10 | 0 |
| 01-type-level-programming/type-fest | 624 | 573 | 91.8% | 91.8% | 2 | 4 | 0 |
| 04-query-builders-orm/drizzle-orm | 578 | 536 | 92.7% | 92.7% | 0 | 1 | 0 |
...
| 06-state-and-forms/xstate | 245 | 210 | 85.7% | 85.7% | 7 | 6 | 0 |
| 03-schema-and-type-level-parsers/zod | 197 | 173 | 87.8% | 87.8% | 2 | 2 | 0 |
...
| **TOTAL** | **7518** | **6584** | **87.6%** | **87.6%** | **107** | **60** | **0** |
...
- **mismatch**: compiled but not type-identical (60); **compile-error**: 545.

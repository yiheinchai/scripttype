...
export function SubDigit(T: Digit, U: Digit, Carry: 0 | 1 = 0): any {
...
/* @scripttype preserveParamNames */
export function SubCarryDigit(T: Digit, U: Digit, Carry: 0 | 1 = 0): any {
...
/* @scripttype preserveParamNames */
export function SubDigits(T: Digit[], U: Digit[], Carry: 0 | 1 = 0, Acc: Digit[] = []): any {

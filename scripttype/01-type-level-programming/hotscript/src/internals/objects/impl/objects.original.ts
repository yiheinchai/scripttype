/**
 * ORIGINAL TypeScript from 01-type-level-programming/hotscript/src/internals/objects/impl/objects.ts, for comparison with the ScriptType alongside.
 *
...
export type RecursiveGet<Obj, pathList> = Obj extends any
...
export type RecursiveUpdate<obj, pathList, fnOrValue> = obj extends any
  ? pathList extends [infer first, ...infer rest]
    ? first extends keyof obj
      ? {

 ...
 * 14 type-level aliases: 8 covered, 6 typecheck-error
 *
...
// ✗ Keys: the ScriptType does not itself typecheck as TypeScript
//   Keys.st.ts(4:11) TS2451: Cannot redeclare block-scoped variable 'm1'.
...
//   RecursiveUpdate.st.ts(6:37) TS2448: Block-scoped variable 'm1' used before its declaration.
/* @scripttype preserveParamNames */

...
export function Length(Str = unset) {
...
//   Cannot find name 'TrimLeftFn'.
/* @scripttype preserveParamNames */
export function TrimLeft(Sep: string | _ = ' ', Str = unset) {
...
//   Cannot find name 'TrimRightFn'.
/* @scripttype preserveParamNames */
export function TrimRight(Sep: string | _ = ' ', Str = unset) {
...
//   Cannot find name 'TrimFn'.
/* @scripttype preserveParamNames */
export function Trim(Sep: string | _ = ' ', Str = unset) {
...
//   Cannot find name 'ReplaceFn'.
/* @scripttype preserveParamNames */
export function Replace(from: string | unset | _ = unset, to: string | unset | _ = unset, str = unset) {
...
//   Namespace 'Strings' has no exported member 'Split'.
/* @scripttype preserveParamNames */
export function Slice(start: number | unset | _ = unset, end: number | unset | _ = unset) {
...
//   Cannot find name 'SplitFn'.
/* @scripttype preserveParamNames */
export function Split(Sep: string | unset | _ = unset, Str: string | unset | _ = unset) {
...
//   Cannot find name 'RepeatFn'.
/* @scripttype preserveParamNames */
export function Repeat(Times: number | _ | unset = unset, Str: string | _ | unset = unset) {
...
//   Cannot find name 'StartsWithFn'.
/* @scripttype preserveParamNames */
export function StartsWith(Start: string | _ | unset = unset, Str: string | _ | unset = unset) {
...
//   Cannot find name 'EndsWithFn'.
/* @scripttype preserveParamNames */
export function EndsWith(End: string | _ | unset = unset, Str: string | _ | unset = unset) {
...
/* @scripttype preserveParamNames */
export function Prepend(Start: string | _ | unset = unset, Str: string | _ | unset = unset) {
...
/* @scripttype preserveParamNames */
export function Append(End: string | _ | unset = unset, Str: string | _ | unset = unset) {
...
/* @scripttype preserveParamNames */
export function Compare(n1: string | _ | unset = unset, n2: string | _ | unset = unset) {
...
/* @scripttype preserveParamNames */
export function LessThan(n1: string | _ | unset = unset, n2: string | _ | unset = unset) {
...
/* @scripttype preserveParamNames */
export function LessThanOrEqual(n1: string | _ | unset = unset, n2: string | _ | unset = unset) {
...
/* @scripttype preserveParamNames */
export function GreaterThan(n1: string | _ | unset = unset, n2: string | _ | unset = unset) {
...
/* @scripttype preserveParamNames */
export function GreaterThanOrEqual(n1: string | _ | unset = unset, n2: string | _ | unset = unset) {

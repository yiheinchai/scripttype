/**
 * ORIGINAL TypeScript from 01-type-level-programming/hotscript/src/internals/strings/impl/compare.ts, for comparison with the ScriptType alongside.
 *
...
export type CharactersCompare<T extends string[], U extends string[]> = T extends [

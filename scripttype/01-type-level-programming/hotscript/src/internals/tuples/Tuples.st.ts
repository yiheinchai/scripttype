 ...
 * 51 type-level aliases: 35 compile-error, 8 mismatch, 5 covered, 3 typecheck-error
 *
...
// ✗ RangeImpl: the ScriptType does not itself typecheck as TypeScript
//   RangeImpl.st.ts(8:17) TS2345: Argument of type 'any' is not assignable to parameter of type 'never'.
/* @scripttype preserveParamNames */
 ...
 * type RangeImpl__loop<Output extends readonly unknown[], Length extends number, Start extends number> = Output['length'] extends Length ? Output : RangeImpl__loop<[...Output, Call<Numbers.Add<Start, Output['length']>>], Length, Start>
 */

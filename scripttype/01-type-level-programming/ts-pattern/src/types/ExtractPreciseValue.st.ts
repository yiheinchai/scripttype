...
// ✗ ExtractPreciseValue: the ScriptType does not itself typecheck as TypeScript
//   ExtractPreciseValue.st.ts(23:14) TS2348: Value of type 'MapConstructor' is not callable. Did you mean to include 'new'?
...
export function ExtractPreciseValue(a, b) {
  ...
  if (m2) {
    ...
    if (m3) {
      return Map(ExtractPreciseValue(m3.ak, m2.bk), ExtractPreciseValue(m3.av, m2.bv))
    }
  ...
  if (m4) {
    ...
    if (m5) {
      return Set(ExtractPreciseValue(m5.av, m4.bv))
    }
    return LeastUpperBound(a, b)
  }

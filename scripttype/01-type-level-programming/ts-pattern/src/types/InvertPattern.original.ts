/**
 * ORIGINAL TypeScript from 01-type-level-programming/ts-pattern/src/types/InvertPattern.ts, for comparison with the ScriptType alongside.
 *
...
export type OptionalKeys<p> = ValueOf<{
...
export type InvertArrayPattern<
  p,
  i,
...
export type InvertPatternInternal<p, input> = 0 extends 1 & p
  ? never
  : p extends Matcher<
      infer _input,
      infer subpattern,
...
export type ExcludeIfExists<a, b> =
...
export type InvertArrayPatternForExclude<
  p,
  i,
  empty,

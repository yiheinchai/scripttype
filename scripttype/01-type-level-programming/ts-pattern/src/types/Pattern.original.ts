/**
 * ORIGINAL TypeScript from 01-type-level-programming/ts-pattern/src/types/Pattern.ts, for comparison with the ScriptType alongside.
 *
...
export type UnknownMatcher = PatternMatcher<unknown>;
...
export type ObjectPattern<a> =
  | {
      readonly [k in keyof a]?: Pattern<a[k]>;
    }
  | never;

export type ArrayPattern<a> = a extends readonly (infer i)[]
...
export type MergeGuards<input, guard1, guard2> = [guard1, guard2] extends [

/**
 * ScriptType for 01-type-level-programming/ts-toolbelt/sources/List/LastKey.ts
 *
...
// ✓ LastKey: verified type-identical to the original
/* @scripttype preserveParamNames */
export function LastKey(L: List): any {
  return Length(Tail(L))
}
/* compiles to:

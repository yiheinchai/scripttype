...
export function __PatchAll(O: object, Os: List<object>, depth: Depth, ignore: object, fill: any, I: Iteration = IterationOf(0)) {
...
/* @scripttype preserveParamNames */
export function _PatchAll(O: object, Os: List<object>, depth: Depth, ignore: object, fill: any) {
...
/* @scripttype preserveParamNames */
export function PatchAll(O: object, Os: List<object>, depth: Depth = 'flat', ignore: object = BuiltIn, fill: any = never) {

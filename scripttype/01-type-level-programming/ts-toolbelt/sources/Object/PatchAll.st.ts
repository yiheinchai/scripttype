/**
 * ScriptType for 01-type-level-programming/ts-toolbelt/sources/Object/PatchAll.ts
 *
...
export function __PatchAll(O: object, Os: List<object>, depth: Depth, ignore: object, fill: any, I: Iteration = IterationOf(0)): any {
...
/* @scripttype preserveParamNames */
export function _PatchAll(O: object, Os: List<object>, depth: Depth, ignore: object, fill: any): any {
  const m1 = matches<Hole<"X">>(__PatchAll(O, Os, depth, ignore, fill))
  if (m1) {
...
/* @scripttype preserveParamNames */
export function PatchAll(O: object, Os: List<object>, depth: Depth = 'flat', ignore: object = BuiltIn, fill: any = never): any {
  if (matches<unknown>(O)) {
    if (matches<unknown>(Os)) {
      return _PatchAll(O, Os, depth, ignore, fill)
    }
    return never
  }
  return never

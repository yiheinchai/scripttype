...
/* @scripttype preserveParamNames */
export function ReadonlyDeep(O) {
  const out = emptyObject
  for (const K in keyof(O)) {
...
/* @scripttype preserveParamNames */
export function ReadonlyPart(O: object, depth: Depth) {
...
/* @scripttype preserveParamNames */
export function _Readonly(O: object, K: Key, depth: Depth) {
...
/* @scripttype preserveParamNames */
export function Readonly(O: object, K: Key = Key, depth: Depth = 'flat') {

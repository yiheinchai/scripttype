...
// ✗ Signums: the ScriptType does not itself typecheck as TypeScript
//   Signums.st.ts(11:14) TS2345: Argument of type 'any' is not assignable to parameter of type 'never'.
/* @scripttype preserveParamNames */
 ...
 * type Signums__loop<N extends string, Acc extends readonly unknown[]> = N extends `${infer Head extends Signum}${infer Rest}` ? Signums__loop<Rest, [...Acc, Head]> : Acc
 */

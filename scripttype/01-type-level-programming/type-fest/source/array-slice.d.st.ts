...
// ✗ ArraySliceByPositiveIndex: the ScriptType does not itself typecheck as TypeScript
//   ArraySliceByPositiveIndex.st.ts(10:17) TS2345: Argument of type 'unknown' is not assignable to parameter of type 'never'.
/* @scripttype preserveParamNames */
 ...
 * type ArraySliceByPositiveIndex__loop<Start extends number, Result extends readonly unknown[], End extends number, Array_ extends readonly unknown[]> = Start extends End ? Result : ArraySliceByPositiveIndex__loop<Sum<Start, 1>, [...Result, Array_[Sum<Start, 1>]], End, Array_>
 */

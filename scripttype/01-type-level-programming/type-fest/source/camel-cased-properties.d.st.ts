...
export function CamelCasedProperties(Value, Options: CamelCaseOptions = {}): any {
 ...
 *   : {
 *     [K in keyof Value as CamelCase<K, ApplyDefaultOptions<CamelCaseOptions, _DefaultCamelCaseOptions, Options>>]: Value[K]
 *   }
 */

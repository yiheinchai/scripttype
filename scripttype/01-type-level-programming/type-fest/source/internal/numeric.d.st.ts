...
// ✗ InternalUnionMin: the ScriptType does not itself typecheck as TypeScript
//   InternalUnionMin.st.ts(8:12) TS2345: Argument of type 'any' is not assignable to parameter of type 'never'.
/* @scripttype preserveParamNames */
 ...
 * type InternalUnionMin__loop<T extends readonly unknown[], N extends number> = T['length'] extends N ? T['length'] : InternalUnionMin__loop<[...T, unknown], N>
 */

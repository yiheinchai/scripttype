...
/* compiles to:
 * export type Recursive<T> = readonly Recursive<T>[]
 */
...
export function MultidimensionalReadonlyArray(Element, Dimensions: number): any {
  ...
  return readonlyArrayOf(MultidimensionalReadonlyArray(Element, Subtract(Dimensions, 1)))
}
/* compiles to:
 ...
 *   : readonly MultidimensionalReadonlyArray<Element, Subtract<Dimensions, 1>>[]
 */

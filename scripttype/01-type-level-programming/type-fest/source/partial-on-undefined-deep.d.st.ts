...
// ✗ _PartialOnUndefinedDeep: the ScriptType does not itself typecheck as TypeScript
//   _PartialOnUndefinedDeep.st.ts(4:11) TS2451: Cannot redeclare block-scoped variable 'm1'.
/* @scripttype preserveParamNames */
...
// ✗ PartialOnUndefinedDeepValue: the ScriptType does not itself typecheck as TypeScript
//   PartialOnUndefinedDeepValue.st.ts(9:37) TS2448: Block-scoped variable 'm1' used before its declaration.
/* @scripttype preserveParamNames */

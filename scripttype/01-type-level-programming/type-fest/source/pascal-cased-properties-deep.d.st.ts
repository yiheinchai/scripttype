...
// ✗ _PascalCasedPropertiesDeep: the ScriptType does not itself typecheck as TypeScript
//   _PascalCasedPropertiesDeep.st.ts(12:12) TS2348: Value of type 'SetConstructor' is not callable. Did you mean to include 'new'?
/* @scripttype preserveParamNames */
export function _PascalCasedPropertiesDeep(Value, Options: Required<CamelCaseOptions>) {
  ...
  if (m1) {
    return Array(_PascalCasedPropertiesDeep(m1.U, Options))
  }
  const m2 = matches<Set<Hole<"U">>>(Value)
  if (m2) {
    return Set(_PascalCasedPropertiesDeep(m2.U, Options))
  }

...
// ✓ UndefinedOnPartialDeep: verified type-identical to the original
/* @scripttype preserveParamNames */
export function UndefinedOnPartialDeep(T): any {
...
/* @scripttype preserveParamNames */
export function UndefinedOnPartialList(T: readonly unknown[]): any {
  if (matches<[ ]>(T)) {
    return []
  }

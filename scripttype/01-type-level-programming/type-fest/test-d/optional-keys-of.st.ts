/**
 * ScriptType for 01-type-level-programming/type-fest/test-d/optional-keys-of.ts
 *
...
export function Test1(T: object) {
  return Assignability1(T, OptionalKeysOf(T))
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability2(T: object, _K: OptionalKeysOf<typeof T>) {
  return unknown
}
/* compiles to:
...
//   Type 'keyof T' does not satisfy the constraint 'OptionalKeysOf<T>'.   Type 'string | number | symbol' is not assignable to type 'OptionalKeysOf<T>'.     Type 's
/* @scripttype preserveParamNames */
...
export function Test3(T: object) {
  return Assignability3(T, OptionalKeysOf(T))
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability4(T: object, _K: OptionalKeysOf<typeof T>) {
  return unknown
}
/* compiles to:
...
export function Test5(T: Record<string, unknown>) {
  return Assignability5(T, OptionalKeysOf(T))
}
/* compiles to:
...
export function Test6(T: object) {
  return Assignability6(T, OptionalKeysOf(T))
}
/* compiles to:
...
export function Test7(T: UnknownRecord) {
  return Assignability7(T, OptionalKeysOf(T))
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability8(T: Record<string, unknown>, _K: OptionalKeysOf<typeof T>) {
  return unknown
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability9(T: object, _K: OptionalKeysOf<typeof T>) {
  return unknown
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability10(T: UnknownRecord, _K: OptionalKeysOf<typeof T>) {
  return unknown
}
/* compiles to:

/**
 * ScriptType for 01-type-level-programming/type-fest/test-d/readonly-keys-of.ts
 *
...
export function Test1(T: object) {
  return Assignability1(T, ReadonlyKeysOf(T))
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability2(T: object, _K: ReadonlyKeysOf<typeof T>) {
  return unknown
}
/* compiles to:
...
//   Type 'keyof T' does not satisfy the constraint 'ReadonlyKeysOf<T>'.   Type 'string | number | symbol' is not assignable to type 'ReadonlyKeysOf<T>'.     Type 's
/* @scripttype preserveParamNames */
...
export function Test3(T: object) {
  return Assignability3(T, ReadonlyKeysOf(T))
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability4(T: object, _K: ReadonlyKeysOf<typeof T>) {
  return unknown
}
/* compiles to:
...
export function Test5(T: Record<string, unknown>) {
  return Assignability5(T, ReadonlyKeysOf(T))
}
/* compiles to:
...
export function Test6(T: object) {
  return Assignability6(T, ReadonlyKeysOf(T))
}
/* compiles to:
...
export function Test7(T: UnknownRecord) {
  return Assignability7(T, ReadonlyKeysOf(T))
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability8(T: Record<string, unknown>, _K: ReadonlyKeysOf<typeof T>) {
  return unknown
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability9(T: object, _K: ReadonlyKeysOf<typeof T>) {
  return unknown
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function Assignability10(T: UnknownRecord, _K: ReadonlyKeysOf<typeof T>) {
  return unknown
}
/* compiles to:

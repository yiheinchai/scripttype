/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-query/packages/angular-query-experimental/src/inject-queries.ts, for comparison with the ScriptType alongside.
 *

...
type QueryObserverOptionsForCreateQueries<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
...
export function QueryObserverOptionsForCreateQueries(TQueryFnData = unknown, TError = DefaultError, TData = TQueryFnData, TQueryKey: QueryKey = QueryKey) {
...
/* compiles to:
 * export type QueryObserverOptionsForCreateQueries<TQueryFnData = unknown, TError = DefaultError, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey> = OmitKeyof<CreateQueryOptions<TQueryFnData, TError, TData, TQueryKey>, 'placeholderData'> & { placeholderData?: TQueryFnData | QueriesPlaceholderDataFunction<TQueryFnData> }
 */

// ✓ GetCreateQueryOptionsForCreateQueries: verified type-identical to the original
/* @scripttype preserveParamNames */
export function GetCreateQueryOptionsForCreateQueries(T) {
...
/* compiles to:
 * export type GetCreateQueryOptionsForCreateQueries<T> = T extends { queryFnData: infer TQueryFnData; error?: infer TError; data: infer TData; } ? QueryObserverOptionsForCreateQueries<TQueryFnData, TError, TData> : T extends { queryFnData: infer TQueryFnData; error?: infer TError; } ? QueryObserverOptionsForCreateQueries<TQueryFnData, TError> : T extends { data: infer TData; error?: infer TError; } ? QueryObserverOptionsForCreateQueries<unknown, TError, TData> : T extends [infer TQueryFnData, infer TError, infer TData] ? QueryObserverOptionsForCreateQueries<TQueryFnData, TError, TData> : T extends [infer TQueryFnData, infer TError] ? QueryObserverOptionsForCreateQueries<TQueryFnData, TError> : T extends [infer TQueryFnData] ? QueryObserverOptionsForCreateQueries<TQueryFnData> : T extends { queryFn?: QueryFunction<infer TQueryFnData, infer TQueryKey> | SkipTokenForCreateQueries; select?: (data: any) => infer TData; throwOnError?: ThrowOnError<any, infer TError, any, any>; } ? QueryObserverOptionsForCreateQueries<TQueryFnData, unknown extends TError ? DefaultError : TError, unknown extends TData ? TQueryFnData : TData, TQueryKey> : QueryObserverOptionsForCreateQueries
 */
...
/* @scripttype preserveParamNames */
export function GetCreateQueryResult(T) {
...
export function QueriesOptions(T: Array<any>, TResults: Array<any> = [], TDepth: ReadonlyArray<number> = []) {
  if (matches<MAXIMUM_DEPTH>(TDepth['length'])) {
    return t<Array<QueryObserverOptionsForCreateQueries>>()
  }
  if (matches<[ ]>(T)) {
    return []
  }
  ...
  if (m3) {
    return t<Array<QueryObserverOptionsForCreateQueries<typeof m3.TQueryFnData, typeof m3.TError, typeof m3.TData, typeof m3.TQueryKey>>>()
  }
  return t<Array<QueryObserverOptionsForCreateQueries>>()
}
/* compiles to:

/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-query/packages/preact-query/src/useSuspenseQueries.ts, for comparison with the ScriptType alongside.
 *

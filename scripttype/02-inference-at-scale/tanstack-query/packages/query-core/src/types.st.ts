 ...
 * 33 type-level aliases: 28 covered, 4 typecheck-error, 1 compile-error
 *
...
// ✗ QueryFunction: the ScriptType does not itself typecheck as TypeScript
//   QueryFunction.st.ts(3:68) TS2348: Value of type 'PromiseConstructor' is not callable. Did you mean to include 'new'?
/* @scripttype preserveParamNames */
export function QueryFunction(T = unknown, TQueryKey: QueryKey = QueryKey, TPageParam = never) {
  return fnType([QueryFunctionContext(TQueryKey, TPageParam)], T | Promise(T))
}
/* compiles to:
...
// ✗ QueryPersister: the ScriptType does not itself typecheck as TypeScript
//   QueryPersister.st.ts(4:101) TS2348: Value of type 'PromiseConstructor' is not callable. Did you mean to include 'new'?
/* @scripttype preserveParamNames */
export function QueryPersister(T = unknown, TQueryKey: QueryKey = QueryKey, TPageParam = never) {
  if (matches<[ never ]>([TPageParam])) {
    return fnType([QueryFunction(T, TQueryKey, never), QueryFunctionContext(TQueryKey), Query], T | Promise(T))
  }
  return fnType([QueryFunction(T, TQueryKey, TPageParam), QueryFunctionContext(TQueryKey), Query], T | Promise(T))
}
/* compiles to:
...
export function GetPreviousPageParamFunction(TPageParam, TQueryFnData = unknown) {
  return fnType([TQueryFnData, Array(TQueryFnData), TPageParam, Array(TPageParam)], anyOf(TPageParam, Undefined, Null))
}
/* compiles to:
...
// ✗ MutationFunction: the ScriptType does not itself typecheck as TypeScript
//   MutationFunction.st.ts(3:56) TS2348: Value of type 'PromiseConstructor' is not callable. Did you mean to include 'new'?
/* @scripttype preserveParamNames */
export function MutationFunction(TData = unknown, TVariables = unknown) {
  return fnType([TVariables, MutationFunctionContext], Promise(TData))
}
/* compiles to:
 * export type MutationFunction<TData = unknown, TVariables = unknown> = (a0: TVariables, a1: MutationFunctionContext) => Promise<TData>
 */

// ✗ MutateFunction: the ScriptType does not itself typecheck as TypeScript
//   MutateFunction.st.ts(3:90) TS2348: Value of type 'PromiseConstructor' is not callable. Did you mean to include 'new'?
/* @scripttype preserveParamNames */
export function MutateFunction(TData = unknown, TError = DefaultError, TVariables = voidType(), TOnMutateResult = unknown) {
  return fnType([TVariables, MutateOptions(TData, TError, TVariables, TOnMutateResult)], Promise(TData))
}
/* compiles to:

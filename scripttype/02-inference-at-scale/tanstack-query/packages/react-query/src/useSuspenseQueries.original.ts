/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-query/packages/react-query/src/useSuspenseQueries.ts, for comparison with the ScriptType alongside.
 *

/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-query/packages/solid-query/src/useMutationState.ts, for comparison with the ScriptType alongside.
 *

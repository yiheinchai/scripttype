/**
 * ScriptType for 02-inference-at-scale/tanstack-query/packages/svelte-query/src/createQueries.svelte.ts
 *
...
export function GetCreateQueryOptionsForCreateQueries(T) {
  ...
  if (m1) {
    return CreateQueryOptionsForCreateQueries(m1.TQueryFnData, m1.TError, m1.TData)
  }
  const m2 = matches<{ queryFnData: Hole<"TQueryFnData">; error?: Hole<"TError">; }>(T)
  if (m2) {
    return CreateQueryOptionsForCreateQueries(m2.TQueryFnData, m2.TError)
  }
  const m3 = matches<{ data: Hole<"TData">; error?: Hole<"TError">; }>(T)
  if (m3) {
    return CreateQueryOptionsForCreateQueries(unknown, m3.TError, m3.TData)
  }
  const m4 = matches<[ Hole<"TQueryFnData">, Hole<"TError">, Hole<"TData"> ]>(T)
  if (m4) {
    return CreateQueryOptionsForCreateQueries(m4.TQueryFnData, m4.TError, m4.TData)
  }
  const m5 = matches<[ Hole<"TQueryFnData">, Hole<"TError"> ]>(T)
  if (m5) {
    return CreateQueryOptionsForCreateQueries(m5.TQueryFnData, m5.TError)
  }
  const m6 = matches<[ Hole<"TQueryFnData"> ]>(T)
  if (m6) {
    return CreateQueryOptionsForCreateQueries(m6.TQueryFnData)
  }
  ...
  if (m7) {
    return CreateQueryOptionsForCreateQueries(m7.TQueryFnData, matches<typeof m7.TError>(unknown) ? DefaultError : m7.TError, matches<typeof m7.TData>(unknown) ? m7.TQueryFnData : m7.TData, m7.TQueryKey)
  }
...
export function QueriesOptions(T: Array<any>, TResults: Array<any> = [], TDepth: ReadonlyArray<number> = []) {
  if (matches<MAXIMUM_DEPTH>(TDepth['length'])) {
    return Array(CreateQueryOptionsForCreateQueries)
  }
  if (matches<[ ]>(T)) {
    return []
  }
  ...
  if (m3) {
    return Array(CreateQueryOptionsForCreateQueries(m3.TQueryFnData, m3.TError, m3.TData, m3.TQueryKey))
  }
  return Array(CreateQueryOptionsForCreateQueries)
}
/* compiles to:

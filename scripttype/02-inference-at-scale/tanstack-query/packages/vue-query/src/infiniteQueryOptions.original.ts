/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-query/packages/vue-query/src/infiniteQueryOptions.ts, for comparison with the ScriptType alongside.
 *

/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-router/packages/react-router/src/RouterProvider.tsx, for comparison with the ScriptType alongside.
 *

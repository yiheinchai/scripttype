...
export function PromptProps(TRouter: AnyRouter = RegisteredRouter, TWithResolver: boolean = boolean, TParams = matches<true>(TWithResolver) ? BlockerResolver(TRouter) : voidType()): any {
  return merge(UseBlockerOpts(TRouter, TWithResolver), { children: optional(t<React.ReactNode>() | fnType([TParams], t<React.ReactNode>())) })
}
/* compiles to:
 ...
 *   & { children?: React.ReactNode | ((a0: TParams) => React.ReactNode) }
 */

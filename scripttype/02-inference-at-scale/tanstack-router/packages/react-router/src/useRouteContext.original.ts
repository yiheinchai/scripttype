/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-router/packages/react-router/src/useRouteContext.ts, for comparison with the ScriptType alongside.
 *

/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-router/packages/router-devtools-core/src/utils.tsx, for comparison with the ScriptType alongside.
 *
...
export type StyledComponent<T> = T extends 'button'

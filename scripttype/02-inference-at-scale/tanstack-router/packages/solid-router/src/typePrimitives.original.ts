/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-router/packages/solid-router/src/typePrimitives.ts, for comparison with the ScriptType alongside.
 *

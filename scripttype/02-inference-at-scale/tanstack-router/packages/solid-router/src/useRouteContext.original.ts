/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-router/packages/solid-router/src/useRouteContext.ts, for comparison with the ScriptType alongside.
 *

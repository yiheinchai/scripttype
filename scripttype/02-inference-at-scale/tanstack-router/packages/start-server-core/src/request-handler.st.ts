...
//   RequestHandler.st.ts(4:57) TS2348: Value of type 'PromiseConstructor' is not callable. Did you mean to include 'new'?
/* @scripttype preserveParamNames */
export function RequestHandler(TRegister) {
  if (matches<true>(HasRequired(RequestOptions(TRegister)))) {
    return fnType([Request, RequestOptions(TRegister)], Promise(Response) | Response)
  }
  return fnType([Request, RequestOptions(TRegister)], Promise(Response) | Response)
}
/* compiles to:

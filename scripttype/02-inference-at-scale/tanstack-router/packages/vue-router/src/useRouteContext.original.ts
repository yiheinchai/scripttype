/**
 * ORIGINAL TypeScript from 02-inference-at-scale/tanstack-router/packages/vue-router/src/useRouteContext.ts, for comparison with the ScriptType alongside.
 *

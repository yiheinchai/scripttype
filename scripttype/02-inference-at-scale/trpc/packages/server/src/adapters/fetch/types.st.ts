...
// ✗ FetchCreateContextFn: the ScriptType does not itself typecheck as TypeScript
//   FetchCreateContextFn.st.ts(3:78) TS2348: Value of type 'PromiseConstructor' is not callable. Did you mean to include 'new'?
/* @scripttype preserveParamNames */
export function FetchCreateContextFn(TRouter: AnyRouter) {
  return fnType([FetchCreateContextFnOptions], inferRouterContext(TRouter) | Promise(inferRouterContext(TRouter)))
}
/* compiles to:

/**
 * ORIGINAL TypeScript from 02-inference-at-scale/trpc/packages/server/src/vendor/standard-schema-v1/spec.ts, for comparison with the ScriptType alongside.
 *

/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/abitype/packages/abitype/src/human-readable/types/signatures.ts, for comparison with the ScriptType alongside.
 *

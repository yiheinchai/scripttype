/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/abitype/packages/abitype/src/human-readable/types/utils.ts, for comparison with the ScriptType alongside.
 *
...
export type Pop<type extends readonly number[]> = type extends [...infer head, any]
  ? head
  : []

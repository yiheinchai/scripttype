/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/abitype/playgrounds/functions/src/types.ts, for comparison with the ScriptType alongside.
 *
...
export type MaybePartialBy<TType, TKeys extends string> = TKeys extends keyof TType

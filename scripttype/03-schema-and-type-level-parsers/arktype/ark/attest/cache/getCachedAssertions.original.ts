/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/arktype/ark/attest/cache/getCachedAssertions.ts, for comparison with the ScriptType alongside.
 *

 ...
 * 15 type-level aliases: 14 covered, 1 typecheck-error
 *
...
import type { Prerequisite, errorContext } from '../../../../../../03-schema-and-type-level-parsers/arktype/ark/schema/kinds.js'
import type { ArkErrorCode, DerivableErrorContext } from '../../../../../../03-schema-and-type-level-parsers/arktype/ark/schema/shared/errors.js'
...
import type { propwiseXor } from '../../../../../../03-schema-and-type-level-parsers/arktype/ark/util/records.js'
...
type meta<T1 = any, T2 = any, T3 = any, T4 = any, T5 = any, T6 = any, T7 = any, T8 = any, T9 = any, T10 = any, T11 = any, T12 = any, T13 = any, T14 = any, T15 = any, T16 = any> = any
// ✓ Handler: verified type-identical to the original
/* @scripttype preserveParamNames */
export function Handler(returns = unknown): any {
...
/* @scripttype preserveParamNames */
export function DerivableErrorContextInput(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function ArkErrorContextInput(code: ArkErrorCode = ArkErrorCode): any {
  return merge(ArkErrorContextInputsByCode[code], { meta: optional(t<ArkEnv.meta>()) })
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function NodeErrorContextInput(code: ArkErrorCode = ArkErrorCode): any {
  return merge(ArkErrorContextInputsByCode[code], { meta: t<ArkEnv.meta>() })
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function MessageContext(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function ProblemContext(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function ProblemConfig(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function ProblemWriter(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function MessageConfig(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function MessageWriter(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function getAssociatedDataForError(code: ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function ExpectedConfig(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function ExpectedWriter(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function ActualConfig(code: ArkErrorCode = ArkErrorCode): any {
...
/* @scripttype preserveParamNames */
export function ActualWriter(code: ArkErrorCode = ArkErrorCode): any {

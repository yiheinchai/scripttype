/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/arktype/ark/type/attributes.ts, for comparison with the ScriptType alongside.
 *
...
type arkPrototypes<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
...
type intersectArrays<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type isSafelyMappable<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
...
export type BuiltinTerminalObjectKind = Exclude<
	arkPrototypes.NonDegenerateName,
	"Array" | "Function"
>

export type TerminallyInferredObject =
...
export interface MorphableIntersection<piped extends boolean>
...
export type _inferNaryPipe<remaining extends readonly unknown[], result> =
	remaining extends (
...
export type _inferNaryIntersection<remaining extends readonly unknown[], result> =
...
export type optionalAtLeastOnceUnionKeyOf<t> =
...
export type _inferNaryMerge<remaining extends readonly unknown[], result> =
	remaining extends (

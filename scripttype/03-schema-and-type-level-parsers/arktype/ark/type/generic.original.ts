/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/arktype/ark/type/generic.ts, for comparison with the ScriptType alongside.
 *
...
export type ParamsTerminator = WhitespaceChar | ","
...
export type extendsToken = typeof extendsToken
...
export type instantiateGeneric<
	def,
...
export interface GenericBodyParser<params extends array<GenericParamAst>, $> {
	<const body>(

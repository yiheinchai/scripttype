/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/arktype/ark/type/parser/shift/operand/unenclosed.ts, for comparison with the ScriptType alongside.
 *
...
export type qualifiedReference<

/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/typebox/src/schema/static/unevaluatedProperties.ts, for comparison with the ScriptType alongside.
 *

/**
 * ScriptType for 03-schema-and-type-level-parsers/typebox/src/type/action/omit.ts
 *
...
import type { TOmitAction } from '../../../../../../03-schema-and-type-level-parsers/typebox/src/type/engine/omit/instantiate.js'
...
export function TOmitDeferred(Type: TSchema, Indexer: TSchema): any {
...
/* @scripttype preserveParamNames */
export function TOmit(Type: TSchema, Indexer: TSchema): any {
  return TOmitAction(Type, Indexer)
}
/* compiles to:

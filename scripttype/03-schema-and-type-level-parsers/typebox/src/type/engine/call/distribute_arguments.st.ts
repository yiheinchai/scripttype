...
// ✗ TAppend: the ScriptType does not itself typecheck as TypeScript
//   TAppend.st.ts(11:17) TS2345: Argument of type 'any[]' is not assignable to parameter of type 'never'.
/* @scripttype preserveParamNames */
 ...
 * type TAppend__loop<Current extends TSchema[][], Result extends readonly unknown[], Type extends TSchema> = Current extends [infer Left extends TSchema[], ...(infer Right extends TSchema[][])] ? TAppend__loop<Right, [...Result, [...Left, Type]], Type> : Result
 */

// ✗ TCross: the ScriptType does not itself typecheck as TypeScript
//   TCross.st.ts(11:5) TS2322: Type 'any[]' is not assignable to type 'never[]'.   Type 'any' is not assignable to type 'never'.
/* @scripttype preserveParamNames */
 ...
 * type TCross__loop<Variants extends TSchema[], Result extends readonly unknown[], Current extends TSchema[][]> = Variants extends [infer Left extends TSchema, ...(infer Right extends TSchema[])] ? TCross__loop<Right, [...Result, ...TAppend<Current, Left>], Current> : Result
 */

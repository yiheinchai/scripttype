...
export function TConstructorParametersOperation(Type: TSchema, Parameters: TSchema[] = matches<TConstructor>(Type) ? Type['parameters'] : [], InstantiatedParameters: TSchema[] = TInstantiateElements({}, TState([], []), Parameters), Result: TSchema = TTuple(InstantiatedParameters)): any {
  return Result
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function TConstructorParametersAction(Type: TSchema, Result: TSchema = matches<true>(TCanInstantiate([Type])) ? TConstructorParametersOperation(Type) : TConstructorParametersDeferred(Type)): any {
  return Result
}
/* compiles to:
...
/* @scripttype preserveParamNames */
export function TConstructorParametersInstantiate(Context: TProperties, State: TState, Type: TSchema, InstantiatedType: TSchema = TInstantiateType(Context, State, Type)): any {

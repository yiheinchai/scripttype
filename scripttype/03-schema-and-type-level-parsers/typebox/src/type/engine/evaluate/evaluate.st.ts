 ...
 * type TEvaluateEnum__loop<Values extends TEnumValue[], Result extends any[]> = Values extends [infer Left extends TEnumValue, ...(infer Right extends TEnumValue[])] ? TEvaluateEnum__loop<Right, [...Result, TLiteral<Left>]> : TEvaluateUnion<Result>
 */

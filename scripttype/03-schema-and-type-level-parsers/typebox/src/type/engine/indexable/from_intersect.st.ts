/**
 * ScriptType for 03-schema-and-type-level-parsers/typebox/src/type/engine/indexable/from_intersect.ts
 *
...
export function TFromIntersect(Types: TSchema[], Evaluated: TSchema = TEvaluateIntersect(Types), Result: string[] = TFromType(Evaluated)): any {
  return Result
}
/* compiles to:

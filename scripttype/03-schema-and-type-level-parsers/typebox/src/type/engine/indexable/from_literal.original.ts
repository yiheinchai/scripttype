/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/typebox/src/type/engine/indexable/from_literal.ts, for comparison with the ScriptType alongside.
 *

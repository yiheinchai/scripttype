...
export function TFromTemplateLiteral(Mapping: TMappingType, Pattern: string, Evaluated: TSchema = TEvaluateTemplateLiteral(Pattern), Result: TSchema = TFromType(Mapping, Evaluated)): any {
  return Result
}
/* compiles to:

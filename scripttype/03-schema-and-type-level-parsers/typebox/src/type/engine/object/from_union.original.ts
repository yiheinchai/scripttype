/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/typebox/src/type/engine/object/from_union.ts, for comparison with the ScriptType alongside.
 *
...
export type TCollapseUnionProperties<Left extends TProperties, Right extends TProperties,
...
export type TReduceVariants<Types extends TSchema[], Result extends TProperties> = (

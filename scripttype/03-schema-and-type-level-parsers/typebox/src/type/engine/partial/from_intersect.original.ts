/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/typebox/src/type/engine/partial/from_intersect.ts, for comparison with the ScriptType alongside.
 *

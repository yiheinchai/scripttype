/**
 * ScriptType for 03-schema-and-type-level-parsers/typebox/src/type/engine/readonly_object/from_intersect.ts
 *
...
export function TFromIntersect(Types: TSchema[], Evaluated: TSchema = TEvaluateIntersect(Types), Result: TSchema = TFromType(Evaluated)): any {
  return Result
}
/* compiles to:
 * export type TFromIntersect<

/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/typebox/src/type/engine/readonly_object/instantiate.ts, for comparison with the ScriptType alongside.
 *

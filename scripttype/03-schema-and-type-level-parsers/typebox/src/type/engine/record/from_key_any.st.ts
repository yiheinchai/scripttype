/**
 * ScriptType for 03-schema-and-type-level-parsers/typebox/src/type/engine/record/from_key_any.ts
 *
...
// ✗ TFromAnyKey: does not compile yet
//   'StringKey' refers to a value, but is being used as a type here. Did you mean 'typeof StringKey'?
/* @scripttype preserveParamNames */
export function TFromAnyKey(Value: TSchema, Result: TSchema = TRecord(t<typeof StringKey>(), Value)): any {
  return Result
}
/* compiles to:
 * export type TFromAnyKey<

/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/typebox/src/type/engine/record/from_key_string.ts, for comparison with the ScriptType alongside.
 *

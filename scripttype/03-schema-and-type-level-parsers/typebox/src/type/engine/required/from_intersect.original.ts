/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/typebox/src/type/engine/required/from_intersect.ts, for comparison with the ScriptType alongside.
 *

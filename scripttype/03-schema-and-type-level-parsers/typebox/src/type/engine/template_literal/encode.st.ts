 ...
 * 16 type-level aliases: 10 covered, 5 raw, 1 typecheck-error
 *
...
// ✗ TEncodeUnion: the ScriptType does not itself typecheck as TypeScript
//   TEncodeUnion.st.ts(11:17) TS2345: Argument of type 'any' is not assignable to parameter of type 'never'.
/* @scripttype preserveParamNames */
 ...
 * type TEncodeUnion__loop<Types extends TSchema[], Result extends readonly unknown[]> = Types extends [infer Head extends TSchema, ...(infer Tail extends TSchema[])] ? TEncodeUnion__loop<Tail, [...Result, TEncodeType<Head, [], ''>]> : TEncodeTypes<Right, `${Pattern}(${TJoinString<Result>})`>
 */

/**
 * ScriptType for 03-schema-and-type-level-parsers/typebox/src/type/extends/null.ts
 *
...
// ✓ TExtendsNull: verified type-identical to the original
/* @scripttype preserveParamNames */
export function TExtendsNull(Inferred: TProperties, Left: TNull, Right: TSchema): any {
  if (matches<TNull>(Right)) {
    return t<Result.TExtendsTrue<typeof Inferred>>()
  }
  return TExtendsRight(Inferred, Left, Right)
}
/* compiles to:
 * export type TExtendsNull<
 *   Inferred extends TProperties,
 *   Left extends TNull,
 *   Right extends TSchema
 * > =
 *   Right extends TNull ? Result.TExtendsTrue<Inferred> : TExtendsRight<Inferred, Left, Right>
 */

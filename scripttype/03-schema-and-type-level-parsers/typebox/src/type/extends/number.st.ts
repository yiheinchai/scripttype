...
export function TExtendsNumber(Inferred: TProperties, Left: TNumber, Right: TSchema): any {
...
/* compiles to:
 * export type TExtendsNumber<
 *   Inferred extends TProperties,
 *   Left extends TNumber,
 *   Right extends TSchema
 * > =
 *   Right extends TNumber ? Result.TExtendsTrue<Inferred> : TExtendsRight<Inferred, Left, Right>
 */

/**
 * ScriptType for 03-schema-and-type-level-parsers/typebox/src/type/extends/string.ts
 *
...
export function TExtendsString(Inferred: TProperties, Left: TString, Right: TSchema): any {

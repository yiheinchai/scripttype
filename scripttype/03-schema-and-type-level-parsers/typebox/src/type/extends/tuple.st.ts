 ...
 * 10 type-level aliases: 7 covered, 2 typecheck-error, 1 compile-error
 *
 ...
 * type TReverse__loop<Types extends TSchema[], Result extends any[]> = Types extends [infer Left extends TSchema, ...(infer Right extends TSchema[])] ? TReverse__loop<Right, [Left, ...Result]> : Result
 */

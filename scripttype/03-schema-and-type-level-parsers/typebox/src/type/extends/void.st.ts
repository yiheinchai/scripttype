/**
 * ScriptType for 03-schema-and-type-level-parsers/typebox/src/type/extends/void.ts
 *
...
/* compiles to:
 * export type TExtendsVoid<
 *   Inferred extends TProperties,
 *   Left extends TVoid,
 *   Right extends TSchema
 * > =
 *   Right extends TVoid ? Result.TExtendsTrue<Inferred> : TExtendsRight<Inferred, Left, Right>
 */

/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/typebox/src/type/script/token/internal/optional.ts, for comparison with the ScriptType alongside.
 *

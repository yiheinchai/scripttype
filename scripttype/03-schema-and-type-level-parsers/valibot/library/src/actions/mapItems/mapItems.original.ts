/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/valibot/library/src/actions/mapItems/mapItems.ts, for comparison with the ScriptType alongside.
 *

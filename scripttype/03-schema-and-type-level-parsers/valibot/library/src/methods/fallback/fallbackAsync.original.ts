/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/valibot/library/src/methods/fallback/fallbackAsync.ts, for comparison with the ScriptType alongside.
 *

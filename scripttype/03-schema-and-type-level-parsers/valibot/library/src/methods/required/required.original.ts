/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/valibot/library/src/methods/required/required.ts, for comparison with the ScriptType alongside.
 *
...
type NonOptionalSchema<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any

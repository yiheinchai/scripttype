/**
 * ORIGINAL TypeScript from 03-schema-and-type-level-parsers/valibot/library/src/schemas/nonNullish/types.ts, for comparison with the ScriptType alongside.
 *

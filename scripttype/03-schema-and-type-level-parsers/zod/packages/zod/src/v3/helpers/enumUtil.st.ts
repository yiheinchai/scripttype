 ...
 * 5 type-level aliases: 2 compile-error, 1 mismatch, 1 typecheck-error, 1 covered
 *
 ...
 * type UnionToTuple__loop<T, Tuple extends readonly unknown[]> = [T] extends [never] ? Tuple : UnionToTuple__loop<Exclude<T, GetUnionLast<T>>, [GetUnionLast<Exclude<T, GetUnionLast<T>>>, ...Tuple]>
 */

/**
 * ORIGINAL TypeScript from 04-query-builders-orm/drizzle-orm/drizzle-orm/src/gel-core/columns/relative-duration.ts, for comparison with the ScriptType alongside.
 *

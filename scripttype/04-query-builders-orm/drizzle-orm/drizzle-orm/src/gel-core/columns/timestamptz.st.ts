/**
 * ScriptType for 04-query-builders-orm/drizzle-orm/drizzle-orm/src/gel-core/columns/timestamptz.ts
 *
...
export function GelTimestampTzBuilderInitial(TName: string): any {

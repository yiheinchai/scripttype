/**
 * ScriptType for 04-query-builders-orm/drizzle-orm/drizzle-orm/src/pg-core/columns/char.ts
 *
...
export function PgCharBuilderInitial(TName: string, TEnum: [ string, ...string[] ], TLength: number | undefined): any {

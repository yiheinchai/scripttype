...
type PgSelectBase<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgSelectQueryBuilderBase<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgTable<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgTableWithColumns<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgViewBase<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgViewWithSelection<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any

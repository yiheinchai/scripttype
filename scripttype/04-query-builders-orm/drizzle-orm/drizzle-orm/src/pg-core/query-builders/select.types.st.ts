 ...
 * 16 type-level aliases: 14 covered, 2 raw
 *
...
type AnyPgSelect<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type AnyPgSelectQueryBuilder<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type AnyPgSetOperatorInterface<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
...
type PgSelectHKTBase<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgSelectQueryBuilderBase<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgSelectQueryBuilderHKT<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgSetOperatorExcludedMethods<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgSetOperatorInterface<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
type PgSetOperatorWithResult<A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any> = any
...
// ✗ PgSelectJoinFn: uses raw() — language gap, does not count as covered
...
// ✗ PgSelectCrossJoinFn: uses raw() — language gap, does not count as covered
//   gap: generic function type
/* @scripttype preserveParamNames */
...
/* compiles to:
 * export type PgSelectPrepare<T extends AnyPgSelect> = PgPreparedQuery<PreparedQueryConfig & { execute: T['_']['result'] }>
 */
...
/* compiles to:
 * export type SetOperatorRestSelect<TValue extends readonly PgSetOperatorWithResult<TResult>[], TResult extends any[]> = TValue extends [infer First, ...infer Rest] ? First extends PgSetOperatorInterface<any, any, any, any, any, any, infer TValueResult, any> ? Rest extends AnyPgSetOperatorInterface[] ? [ValidateShape<TValueResult[number], TResult[number], TypedQueryBuilder<any, TValueResult>>, ...SetOperatorRestSelect<Rest, TResult>] : ValidateShape<TValueResult[number], TResult[number], TypedQueryBuilder<any, TValueResult>[]> : never : TValue
 */

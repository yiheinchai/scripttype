/**
 * ORIGINAL TypeScript from 04-query-builders-orm/drizzle-orm/drizzle-orm/src/singlestore-core/columns/boolean.ts, for comparison with the ScriptType alongside.
 *

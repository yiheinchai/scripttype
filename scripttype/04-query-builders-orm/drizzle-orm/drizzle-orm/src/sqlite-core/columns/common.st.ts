...
export function AnySQLiteColumn(TPartial: Partial<ColumnBaseConfig<ColumnDataType, string>> = {}): any {
 ...
 * > =
 *   SQLiteColumn<Required<Update<ColumnBaseConfig<ColumnDataType, string>, TPartial>>>
 */

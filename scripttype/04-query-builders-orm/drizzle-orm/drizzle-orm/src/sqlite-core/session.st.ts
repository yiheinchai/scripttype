...
// ✗ ExecuteResult: the ScriptType does not itself typecheck as TypeScript
//   ExecuteResult.st.ts(4:12) TS2348: Value of type 'PromiseConstructor' is not callable. Did you mean to include 'new'?
...
// ✗ Result: the ScriptType does not itself typecheck as TypeScript
//   Result.st.ts(3:34) TS2348: Value of type 'PromiseConstructor' is not callable. Did you mean to include 'new'?
/* @scripttype preserveParamNames */
export function Result(TKind: 'sync' | 'async', TResult) {
  return { sync: TResult, async: Promise(TResult) }[TKind]
}
/* compiles to:

/**
 * ScriptType for 04-query-builders-orm/drizzle-orm/drizzle-valibot/src/utils.ts
 *
...
export function RemoveNeverElements(T: any[]) {
  ...
  if (m1) {
    if (matches<true>(IsNever(m1.First))) {
      return RemoveNeverElements(m1.Rest)
    }
    return [m1.First, ...RemoveNeverElements(m1.Rest)]
  }
  return []
}
/* compiles to:

/**
 * ORIGINAL TypeScript from 04-query-builders-orm/kysely/src/util/infer-result.ts, for comparison with the ScriptType alongside.
 *
...
export type ResolveResult<O> = O extends

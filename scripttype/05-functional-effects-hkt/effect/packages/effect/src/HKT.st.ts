...
import type { Contravariant, Covariant, Invariant } from '../../../../../../05-functional-effects-hkt/effect/packages/effect/src/Types.js'
...
declare const Contravariant: any
...
export function Kind(F: TypeLambda, In, Out2, Out1, Target): any {
  ...
  return { F: readonlyProp(F), In: readonlyProp(t<Types.Contravariant<typeof In>>()), Out2: readonlyProp(t<Types.Covariant<typeof Out2>>()), Out1: readonlyProp(t<Types.Covariant<typeof Out1>>()), Target: readonlyProp(t<Types.Invariant<typeof Target>>()) }
}
/* compiles to:

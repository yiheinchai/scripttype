/**
 * ORIGINAL TypeScript from 05-functional-effects-hkt/effect/packages/effect/src/unstable/cluster/EntityProxyServer.ts, for comparison with the ScriptType alongside.
 *

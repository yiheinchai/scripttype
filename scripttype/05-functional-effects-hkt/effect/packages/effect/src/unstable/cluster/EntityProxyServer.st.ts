...
export function RpcHandlers(Rpcs: Rpc.Any, Prefix: string): any {
  const m1 = matches<Rpc.Rpc<Hole<"_Tag">, Hole<"_Payload">, Hole<"_Success">, Hole<"_Error">, Hole<"_Middleware">, Hole<"_Requires">>>(Rpcs)
  if (m1) {
    return t<Rpc.Handler<`${typeof Prefix}.${typeof m1._Tag}`>>() | t<Rpc.Handler<`${typeof Prefix}.${typeof m1._Tag}Discard`>>()
  }
  return never
}
/* compiles to:
 * export type RpcHandlers<Rpcs extends Rpc.Any, Prefix extends string> =
 *   Rpcs extends Rpc.Rpc<infer _Tag, any, any, any, any, any>

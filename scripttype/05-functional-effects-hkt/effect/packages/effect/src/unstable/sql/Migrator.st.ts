...
import type { ResolvedMigration } from '../../../../../../../../05-functional-effects-hkt/effect/packages/effect/src/unstable/sql/Migrator.js'
...
export function Loader(R = never): any {
  return t<Effect.Effect<ReadonlyArray<ResolvedMigration>, MigrationError, typeof R>>()
}
/* compiles to:

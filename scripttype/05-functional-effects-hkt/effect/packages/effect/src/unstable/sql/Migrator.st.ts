...
export function Loader(R = never) {
  return Effect.Effect(readonlyArrayOf(ResolvedMigration), MigrationError, R)
}
/* compiles to:
 * export type Loader<R = never> = Effect.Effect<readonly ResolvedMigration[], MigrationError, R>
 */

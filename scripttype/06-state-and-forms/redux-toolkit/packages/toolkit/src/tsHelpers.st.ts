 ...
 * 26 type-level aliases: 23 covered, 1 compile-error, 1 raw, 1 typecheck-error
 *
 ...
 * type ExcludeFromTuple__loop<T, Acc extends any[], E> = T extends [infer Head, ...infer Tail] ? ExcludeFromTuple__loop<Tail, [...Acc, ...([Head] extends [E] ? [] : [Head])], E> : Acc
 */

...
// ✗ StateNodeIterable: the ScriptType does not itself typecheck as TypeScript
//   StateNodeIterable.st.ts(3:10) TS2693: 'Iterable' only refers to a type, but is being used as a value here.
/* @scripttype preserveParamNames */
export function StateNodeIterable(TContext: MachineContext, TE: EventObject) {
  return Iterable(StateNode(TContext, TE))
}
/* compiles to:

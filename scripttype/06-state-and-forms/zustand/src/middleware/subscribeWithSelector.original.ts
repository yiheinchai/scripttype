/**
 * ORIGINAL TypeScript from 06-state-and-forms/zustand/src/middleware/subscribeWithSelector.ts, for comparison with the ScriptType alongside.
 *
...
export type WithSelectorSubscribe<S> = S extends { getState: () => infer T }
